...
int main() {
  ...
  // Заповнення словника через insert та emplace
  for (int i = 0; i < sizeof(NUMBERS) / sizeof(char*);
    i++) {
...
// Вивід на екран розмірів, максимальних розмірів і
// кількості п'ятірок
  cout << "\n #size  - M1 : " << M1.size() <<
    ", M2 : " << M2.size()<<
