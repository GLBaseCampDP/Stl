// stl_lower_upper_bound_equal_range.cpp: определяет точку входа для консольного приложения.
//
...
<<"\n  - Index: " << it - v.begin() << "   Value: " << *it <<"\n";

#define ALL v.begin(), v.end()

#define OUT_Pair cout << \
"\n  - First Index: " <<  p.first - v.begin() << "  Value: " << *p.first <<\
"\n  - Last Index: " << p.second - v.begin() << "  Value: " << *p.second << "\n";
...
int main()
{
	...
	it = lower_bound(ALL, 2, cmp);	OUT(" lower_bound (Comp = a + 2 < 4)", it);
